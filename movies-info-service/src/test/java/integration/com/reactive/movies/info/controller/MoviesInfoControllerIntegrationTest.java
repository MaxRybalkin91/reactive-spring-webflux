...
import com.reactive.movies.info.TestContainersConfig;
import com.reactive.movies.info.domain.MovieInfo;
import com.reactive.movies.info.repository.MovieInfoRepository;
...
class MoviesInfoControllerIntegrationTest extends TestContainersConfig {
    ...
    @Test
    void getMovieInfoByYear_success() {
        webTestClient
                .get()
    ...
    void deleteMovieInfoById_success() {
        ...
        webTestClient
                ...
                .consumeWith(movieInfoEntityExchangeResult -> {
                    assert movieInfoRepository.findById(movieInfoId).block() == null;
                });
    }
